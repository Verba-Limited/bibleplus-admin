...
function isAdminUserRecord(value: unknown): value is AdminUserRecord {
  return (
    !!value && typeof value === "object" && "_id" in value && "email" in value
  );
}
        ...
        <div className="grid grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1fr)_420px]">
          ...
          <aside className="space-y-6">
              ...
              {selectedUser ? (
                <div className="space-y-4">
                  ...
                  <MetaRow
                    icon={MapPin}
                    label="Location"
                    value={selectedUser.location || "No location"}
                  />
                  <MetaRow
                    icon={Bell}
                    label="Notifications"
            ...
            <section className="rounded-xl border border-slate-800 bg-slate-900/50 p-5 backdrop-blur-sm">
              ...
              <p className="mt-1 text-sm text-slate-400">
                PUT /admin/users/:id/reset-password. Leave blank if the backend
